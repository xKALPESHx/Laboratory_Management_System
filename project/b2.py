...
titel=Label(text="Borrow Chemicals",font=("Times New Roman",20,"bold"),bg="light steel blue",fg="black").place(x=430,y=10)
root.left=ImageTk.PhotoImage(file="image/t.jpg")
left=Label(root,image=root.left).place(x=0,y=0,width=350,height=450)
#======================================================
l1=Label(root,text="Select Chemicals:",font=("Times New Roman",15,"bold"),bg="light steel blue",fg="black").place(x=370,y=60)
...
l4=Label(text="Chemical State:",font=("Times New Roman",15,"bold"),bg="light steel blue",fg="black").place(x=370,y=230)
cb = ttk.Combobox(root,font = ("Times New Roman",10),state = "readonly")
cb["values"]=("Solid","Lequid","Gas")
...
def buttonFunction():
    ...
    command_handler.execute("insert into b2 values(%s,%s,%s,%s,%s)",(
                                                                cb1.get(),
                                                                var_en.get(),
                                                                cb.get(),
                                                                var_bd.get(),
    ...
    db.commit()
    db.close()
    messagebox.showinfo("Sucsses","Entry Recorded",parent=root)
